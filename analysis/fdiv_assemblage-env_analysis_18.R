...
funct.div.c.m <- with(c.data, dbFD(data[,c(1:2,7:8)], comm, w.abun=TRUE, stand.x=TRUE))
...
colnames(fdiv.c.m) <- c("fdis","CWM.SLA","CWM.LA","CWM.maxht", "CWM.mn.ht","nsp", "sesmpd","sesmntd", "pd", "simpsdiv")
...
# ...for temperature
mean <- with(s.fd.c.m, lm(mean~elev+aspect+slope))
min <- with(s.fd.c.m, lm(min~elev+aspect+slope))
max <- with(s.fd.c.m, lm(max~elev+aspect+slope))
sd <- with(s.fd.c.m, lm(sd~elev+aspect+slope))

# ...for soil texture percentages
sand <- with(s.fd.c.m, lm(SAND~elev+aspect+slope))
silt <- with(s.fd.c.m, lm(SILT~elev+aspect+slope))
clay <- with(s.fd.c.m, lm(CLAY~elev+aspect+slope))
...
fdis.t <- with(s.fd.c.m, lm(fdis~mean+sd+max+min)) # mean sig
fdis.s <- with(s.fd.c.m, lm(fdis~SILT+CLAY)) # with sand in there it says that there are aliased coefficients (SAND and CLAY)
vif(fdis.t) # mean, max, sd all concerningly correlated
vif(fdis.s)
# produces the same results for all of the dependent variables below and doesn't need to be squared

with(s.fd.c.m, cor(fdis, mean, method = "pearson"))
with(s.fd.c.m, cor(fdis, sd, method = "pearson"))
with(s.fd.c.m, cor(fdis, max, method = "pearson"))
with(s.fd.c.m, cor(fdis, min, method = "pearson"))
with(s.fd.c.m, cor(fdis, SAND, method = "pearson"))
with(s.fd.c.m, cor(fdis, SILT, method = "pearson"))
with(s.fd.c.m, cor(fdis, CLAY, method = "pearson"))

with(s.fd.c.m, cor(log(CWM.SLA), mean, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.SLA), sd, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.SLA), max, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.SLA), min, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.SLA), SAND, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.SLA), SILT, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.SLA), CLAY, method = "pearson"))

with(s.fd.c.m, cor(log(CWM.LA), mean, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.LA), sd, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.LA), max, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.LA), min, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.LA), SAND, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.LA), SILT, method = "pearson"))
with(s.fd.c.m, cor(log(CWM.LA), CLAY, method = "pearson"))

with(s.fd.c.m, cor(CWM.mn.ht, mean, method = "pearson"))
with(s.fd.c.m, cor(CWM.mn.ht, sd, method = "pearson"))
with(s.fd.c.m, cor(CWM.mn.ht, max, method = "pearson"))
with(s.fd.c.m, cor(CWM.mn.ht, min, method = "pearson"))
with(s.fd.c.m, cor(CWM.mn.ht, SAND, method = "pearson"))
with(s.fd.c.m, cor(CWM.mn.ht, SILT, method = "pearson"))
with(s.fd.c.m, cor(CWM.mn.ht, CLAY, method = "pearson"))

with(s.fd.c.m, cor(CWM.maxht, mean, method = "pearson"))
with(s.fd.c.m, cor(CWM.maxht, sd, method = "pearson"))
with(s.fd.c.m, cor(CWM.maxht, max, method = "pearson"))
with(s.fd.c.m, cor(CWM.maxht, min, method = "pearson"))
with(s.fd.c.m, cor(CWM.maxht, SAND, method = "pearson"))
with(s.fd.c.m, cor(CWM.maxht, SILT, method = "pearson"))
with(s.fd.c.m, cor(CWM.maxht, CLAY, method = "pearson"))

# Final models
fdis <- with(s.fd.c.m, lm(fdis~mean+min+CLAY))
cwm.sla <- with(s.fd.c.m, lm(log(CWM.SLA)~mean+min+CLAY))
cwm.la <- with(s.fd.c.m, lm(log(CWM.LA)~mean+min+SILT))
cwm.mnH <- with(s.fd.c.m, lm(CWM.mn.ht~mean+min+CLAY))
cwm.mxH <- with(s.fd.c.m, lm(CWM.maxht~mean+min+CLAY))

fdis <- with(s.fd.c.m, lm(fdis~(mean+min)*class)) # intercept & mean
cwm.sla <- with(s.fd.c.m, lm(log(CWM.SLA)~(mean+min)*class)) # just intercept
cwm.la <- with(s.fd.c.m, lm(log(CWM.LA)~(mean+min)*class)) # intercept, mean, and min:SaLo
cwm.mnH <- with(s.fd.c.m, lm(CWM.mn.ht~(mean+min)*class)) # NS
cwm.mxH <- with(s.fd.c.m, lm(CWM.maxht~(mean+min)*class))
