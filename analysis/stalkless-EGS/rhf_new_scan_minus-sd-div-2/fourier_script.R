#Script automatically generated by stalkess - 2021-12-06 18:45:48

#Headers
library(Momocs)
source('/Users/elizabeth/Documents/projects/functional_traits_rhf/analysis/stalkless-EGS/rhf_new_scan_minus-sd-div-2/stalkless_headers.R')
cat("\n*Please* cite Momocs when using this code\nThis is little more than a minor modification of their\n*Excellent* package!\n")

#Load images
images <- list.files('/Users/elizabeth/Documents/projects/functional_traits_rhf/analysis/stalkless-EGS/rhf_new_scan_minus-sd-div-2/processed_images/')
images <- images[grepl('.jpg', images, fixed=TRUE)]
images <- paste('/Users/elizabeth/Documents/projects/functional_traits_rhf/analysis/stalkless-EGS/rhf_new_scan_minus-sd-div-2/processed_images/', images, sep='')
